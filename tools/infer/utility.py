...
def parse_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default='./models/ch_ppocr_server_v2.0_det_infer')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='./models/ch_ppocr_server_v2.0_rec_infer')
